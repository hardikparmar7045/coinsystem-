...
Route::get('/request-coin', [CoinRequestController::class, 'create'])->name('coin-request.create');
...
Route::get('/request-status', [CoinRequestController::class, 'checkStatus'])->name('coin-request.status');
